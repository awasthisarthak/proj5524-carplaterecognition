...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:
        ...
        if Main.showSteps == True: # show steps ###################################################
            cv2.imshow("Img_Plate", possiblePlate.imgPlate)
            cv2.imshow("Img_Grayscale", possiblePlate.imgGrayscale)
            cv2.imshow("Img_Thresholded", possiblePlate.imgThresh)
        # end if # show steps #####################################################################
        ...
        if Main.showSteps == True: # show steps ###################################################
            cv2.imshow("Img_Thresholded_Resized", possiblePlate.imgThresh)
        # end if # show steps #####################################################################
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        retval, npaResults, neigh_resp, dists = kNearest.findNearest(npaROIResized, k = 7)              # finally we can call findNearest !!!
    ...
    if Main.showSteps == True: # show steps #######################################################
        cv2.imshow("Img_Thresholded_Colored", imgThreshColor)
    # end if # show steps #########################################################################
